  ...
  return (
    <section className="donation-section py-12 bg-[#112221] text-white">
      <div className="container mx-auto text-center">
        <h2 className="text-3xl font-bold mb-4">How You Can Donate</h2>
        ...
        <div className="card-container flex flex-col xl:flex-row justify-around">
          <div className="card bg-white text-black border border-gray-200 rounded-lg shadow-md p-6 m-2 w-full xl:w-1/4">
            ...
            <button className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700 inline-block">Donate Now</button>
          </div>
          <div className="card bg-white text-black border border-gray-200 rounded-lg shadow-md p-6 m-2 w-full xl:w-1/4">
            <h3 className="text-xl font-semibold mb-2">Help in Kind</h3>
            <p className="mb-4">Donate items like clothes, books, and toys.</p>
            <button className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700 inline-block">Nearby DropPoint</button>
          </div>
          <div className="card bg-white text-black border border-gray-200 rounded-lg shadow-md p-6 m-2 w-full xl:w-1/4">
            <h3 className="text-xl font-semibold mb-2">Volunteer</h3>
            <p className="mb-4">Volunteer for providing relief to the needy.</p>
            <button className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-700 inline-block">Volunteer</button>
          </div>
        </div>
      </div>
    </section>
